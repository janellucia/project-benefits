  ...
  <div :class="['each-card', {fullWidth: fullWidth}]">
    <div class="in-progress">
      ...
      <div class="card-body container">
        <h3 class="project-name">Risk Analysis <button class="trash float-right" aria-label="delete project"></button></h3>
      ...
      <div class="status-bar"></div>
        <b-collapse id="inProgress">
          <b-container >
            <b-row class="pv-body">
              <div class="pv-status-bar"></div>
              <b-col md="12" class="results-header">
                <h4>Closure Survey Results</h4>
                <button class="trash float-right" aria-label="delete project"></button>
                <button class="close-survey-button float-right">Close Survey</button>
              </b-col>
              <b-col md="6" class="d-flex flex-column open-date-wrap">
                <p>Opened on</p>
                <h5>February 12, 2019</h5>
              </b-col>
              <b-col md="6">
                <form>
                  <label for="copy-link-input" class="copy-link-label">Send the survey link to the <span>Sponsors, Project Team</span> and <span>Impacted Users</span>.</label>
                  <div class="input-group copy-link-wrap">
                    <input type="text" class="form-control" value="https://www.infotech.com/surveyurlhere" placeholder="Some path" id="copy-link-input">
            ...
            <b-row class="stats">
              <b-col md="4" class="completion-stats">
                <h5>Completion Stats</h5>
                <div class="completed">
                  <p class="number">10</p>
                  <p class="type">Completed</p>
                </div>
                <div class="partial">
                  <p class="number">2</p>
                  <p class="type">Partial</p>
                </div>
                <h6>Overall</h6>
              </b-col>
              <b-col md="8" class="by-role">
                <h5>Survey Completions and Partial Responses by Role</h5>
                <div class="stats-breakdown d-flex">
                  <b-col>
                    <div class="completed">
                      <p class="number">2</p>
                      <p class="type">Completed</p>
            ...
            <button class="btn btn-book-call">Book an Analyst Call</button>
        </b-container>
      </b-collapse>
    </div>
  </div>
